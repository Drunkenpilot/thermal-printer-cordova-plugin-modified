...
public class ThermalPrinterCordovaPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) {
        cordova.getThreadPool().execute(() -> {
            try {
                ...
                } else if (action.equals("bitmapToHexadecimalStringLarge")) {
                    ThermalPrinterCordovaPlugin.this.bitmapToHexadecimalStringLarge(callbackContext,
    ...
    private void bitmapToHexadecimalStringLarge(CallbackContext callbackContext, JSONObject data) throws JSONException {
        try {
            String encodedString = data.getString("base64");
            byte[] decodedString = Base64.decode(encodedString.contains(",")
                    ? encodedString.substring(encodedString.indexOf(",") + 1)
            ...
            for (int y = 0; y < height; y += 256) {
                ...
                stringList.add(PrinterTextParserImg.bitmapToHexadecimalString(printer, bitmap));
            }
