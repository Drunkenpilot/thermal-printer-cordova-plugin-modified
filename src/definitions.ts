...
export interface ThermalPrinterPlugin {
  ...
  listPrinters(
    ...
    success: (value: Printer[]) => any,
    error: (value: ErrorResult) => void
  ): void;
  ...
  getEncoding(
    data: PrinterToUse,
    success: (value: GetEncodingResult) => any,
    error: (value: ErrorResult) => void
  ): void;
  ...
  requestPermissions(
    data: PrinterToUse,
    success: (value: RequestPermissionsResult) => any,
    error: (value: ErrorResult) => void
  ): void;
  ...
  bitmapToHexadecimalString(
    data: BitmapToHexadecimalString,
    success: (value: string) => any,
    error: (value: ErrorResult) => void
  ): void;
   ...
   * @param {function} error
   */
  bitmapToHexadecimalStringLarge(
    data: BitmapToHexadecimalString,
    success: (value: string[]) => any,
    error: (value: ErrorResult) => void
  ): void;
